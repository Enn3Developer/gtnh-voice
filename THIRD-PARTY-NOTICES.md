...
math utilities, the AES encryption implementation, and the pure-Java Opus codec wrappers)
are adapted from [Plasmo Voice](https://github.com/plasmoapp/plasmo-voice), copyright the
